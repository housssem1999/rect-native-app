...
const persons = [ /* list of person data from earlier */{ name: "Radiologue 1", id: 1 }, { name: "Radiologue 2", id: 2 },{ name: "Radiologue 3", id: 3 },{ name: "Radiologue 4", id: 4 },{ name: "Radiologue 5", id: 5 }];
...
export default function ({
  ...
  return (
    <Layout>
      <TopNav
        middleContent="Rendez-vous chez Radiologue"
        leftContent={
          <Ionicons
            name="chevron-back"
            size={20}
