...
export default function ({
  ...
  const list = [`Matricule: ${JSON.stringify(item.item.id)}` , `Email: ${JSON.stringify(item.item.email)}`, `Téléphone: ${JSON.stringify(item.item.phone)}`, `Spécialite: ${JSON.stringify(item.item.specialite)}`, `Adresse: ${JSON.stringify(item.item.adresse)}`]
